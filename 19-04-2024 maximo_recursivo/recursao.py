...
class TestStringMethods(unittest.TestCase):
    ...
    def test_204_max_so_tem_negativo(self):
        self.assertEqual(maximo([-1]), -1)
        self.assertEqual(maximo([-1,-2]), -1)
    
    
    def test_205_max_eh_recursivo(self):
        sys.setrecursionlimit(50)
        try:
