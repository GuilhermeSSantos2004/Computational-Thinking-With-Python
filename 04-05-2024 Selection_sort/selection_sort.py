...
def menor(lista):
    menor_atual = lista[0]
    for elemento in lista:
        if elemento < menor_atual:
            menor_atual = elemento
    return  menor_atual
'''
...
def indice_menor(lista):
    indice = 0
    menor_elem_lista_atual = lista[0]
    for i in range(len(lista)):
        if lista[i] < menor_elem_lista_atual:
            indice = i
            menor_elem_lista_atual = lista[i]
    return indice
