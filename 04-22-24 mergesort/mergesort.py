...
def merge(lista1, lista2):
    i1 = 0  # índice para lista1
    i2 = 0  # índice para lista2
    merged_list = []  # lista para armazenar os elementos mesclados
    while i1 < len(lista1) and i2 < len(lista2):
      
        if lista1[i1] < lista2[i2]:
         
            merged_list.append(lista1[i1])
            i1 += 1
        else:
            
            merged_list.append(lista2[i2])
            i2 += 1
...
print(merge([1,3,5,7,9], [0,2,4,6,8]))
